...
<button   type="button" class="btn btn-default dropdown-toggle" onclick='window.location.href="index_user.php?id2=<?php echo $id2 ?>&choix=index_user";' data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="btn-group">
             ...
             <div class="btn-group">
               <button   type="button" onclick='window.location.href="index_user.php?id2=<?php echo $id2 ?>&choix=liste_user";'  class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				    <a   href="#"><i class="glyphicon glyphicon-user">&nbspListe_Utilisateurs</i></a></span>
				  </button>
          </div>
