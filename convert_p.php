<?php
 ...
 $devise2='' ;
	...
	if($montant1>1000000000){
	
	
   $v1=substr($montant1,-1,1);
     $v2=substr($montant1,-2,1);
      $v3=substr($montant1,-3,1);
   ...
   $unite[1]=$v1;
	...
	$valeur_entiere=intval($montant1);
	
    $valeur_decimal=intval(round($montant1-intval($montant1), 2)*100);
